...
export default function Page({ params }: { params: { token: string } }) {
    ...
    switch (pageContent) {
        ...
        case 'success': contentToLoad = <LinkState title="YOUR NEW PASSWORD IS SET" text="Your password has been successfully modified. Enjoy the extension and don’t forget it this time." succes={true} />; break;
    }
