...
export default function Page() {
    ...
    return(
        <div className="w-screen h-screen relative flex justify-center items-center">
            ...
            <div className="bg-semi-black rounded-md border border-gray py-16 px-[9.75rem]">
                <p className="font-bold text-[4rem] leading-[140%] mb-4 text-center">THANK YOU <br/> FOR USING ViZBL</p>
                ...
                <form className="flex flex-col" onSubmit={(e) => {e.preventDefault(); sendFeedback();}}>
                    ...
                    <button className="py-4 px-7 colored-button border border-transparent hover:border-white font-bold mx-auto">Submit responses</button>
                </form>
            </div>
        </div>
    )
